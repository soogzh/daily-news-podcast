...
4. 【极度重要】只讨论“科技”、“财经”、“国际政治/宏观”相关的新闻。如果素材中包含社会新闻、娱乐八卦、民生琐事、体育、犯罪案件等，必须直接丢弃，绝对不要在播客中提及！
5. 内容必须基于新闻素材，不得编造事实。
6. 涉及政治内容时保持客观、中立、谨慎，不做煽动性评论。
7. 开头要有节目开场，结尾要有总结和告别。
8. 语言口语化，不要书面化。
9. 不要出现“根据素材”“作为AI”“以下是剧本”等词语。
"""
